      ...
      <div className="bg-white dark:bg-[#111827] rounded-[2.5rem] p-6 border border-slate-200 dark:border-slate-800 shadow-sm flex-1">
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between p-4 bg-slate-50 dark:bg-slate-800/50 rounded-2xl">
            <div className="flex items-center text-slate-600 dark:text-slate-400 font-bold"><Users size={18} className="mr-3 text-blue-500" /> Waiting</div>
            <span className="text-xl font-black text-slate-900 dark:text-white">{queueLength}</span>
          </div>
          <div className="flex items-center justify-between p-4 bg-slate-50 dark:bg-slate-800/50 rounded-2xl">
            <div className="flex items-center text-slate-600 dark:text-slate-400 font-bold"><Clock size={18} className="mr-3 text-emerald-500" /> Completed</div>
