...
export default function Login({ onLogin }) {
  ...
  return (
    <div className="max-w-md mx-auto mt-16 p-10 bg-white rounded-[2.5rem] shadow-xl border border-slate-100">
      
      {/* Header */}
      <div className="text-center mb-10">
        <h2 className="text-3xl font-black tracking-tight text-slate-900">Welcome Back</h2>
        <p className="text-slate-400 font-medium mt-2">Access your medical dashboard</p>
      </div>
